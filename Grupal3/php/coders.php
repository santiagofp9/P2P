              ...
              <div class="modal-dialog" role="document">
                <div class="modal-content">
                  <div class="modal-body">
                    ...
                    <a href="eliminar_coder.php?eli=<?php echo $arrlist[6]; ?>" class="btn btn-danger">Eliminar</a>
                    </div>
                  </div>
                </div>
              </div>
    ...
    <div class="popup">
      ...
      <form method="post" action="agregar_coder.php" onsubmit="return validarCoder()" >
        ...
        <div class="form-row">                   
          ...
          Año<br>
          <select name="anyo" id="anyo" onblur="dias()" class="form-control">
            <?php
              for ($i=1950; $i<=2002 ; $i++) {?>
          ...
          <div class="form-group col-md-4">
          Mes<br>
          <select name="mes" id="mes" onblur="dias()" class="form-control">
            <?php
              for ($i=1; $i<=12 ; $i++) {?>
                <option value="<?php echo $i; ?>">
                  <?php echo $i; ?>
