                            ...
                            <th class="datos">Estado</th>
                                ...
                                <?php 
                                 include 'conexion.php';
                                  ...
                                  $list="SELECT login.usuario, promocion.nombre, historial.estado, historial.fk_usuario FROM historial,login,promocion  where historial.fk_usuario=login.idUser and historial.fk_promocion = promocion.id_promocion";
                                  ...
                                  $cont=1;
                                    while ($arrlist= mysqli_fetch_array($con_list)) {?>
                                          <tr>
                                              ...
                                              <td><a href="modificar_historial.php?mod=<?php echo $arrlist[3]; ?>&p=<?php echo $arrlist[3]; ?>" class="btn btn-primary"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
                                              </td>
                                          </tr>     
                                <?php 
                                  $cont++;
